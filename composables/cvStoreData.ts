const Experience = [
  ...
  },
  {
    ...
    skills: ["Project Planning", "Data Analysis", "Jira", "Agile Project Management", "Agile Methodologies", "User Experience (UX)", "User Experience Design (UED)", "Angular"],
  },
  {
    company: "4PSA",
    type: "Full-Time",
...
const ExperienceFront = [...Experience] as any[]
ExperienceFront[1] = { ...Experience[1], position: ["Scrum Master", "Frontend Developer"], }
ExperienceFront[2] = { ...Experience[2], position: ["Scrum Master", "Full Stack Developer"], }
ExperienceFront[3] = { ...Experience[3], position: ["Scrum Master", "Full Stack Developer"], }
...
export const mkCvData: {
  ...
  Experience: {
    [CvQuery.frontend]: Experience as CvExperience[],
    [CvQuery.scrum]: ExperienceFront as CvExperience[],
  }
